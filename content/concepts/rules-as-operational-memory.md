...
**지속적으로 참조 가능한 형태로 저장**해 둔다는 뜻이다. 이 규칙들이 어디에 배치되고 어떤 우선순위로 적용되는지는 [[concepts/claude-md-and-instruction-hierarchy|CLAUDE.md & Instruction Hierarchy]]에서 다룬다.
...
- 자주 반복되는 판단
- [[concepts/team-conventions-and-reproducibility|팀 전체가 공유]]해야 하는 기준
- 실수 비용이 큰 금지사항
- 검증/테스트/리뷰에 관한 루틴
...
- 반복 판단을 외부화하고
- 자주 필요한 제약을 고정하고
- 위험한 행동의 기준선을 만들고 ([[concepts/hooks-and-enforcement|Hooks & Enforcement]]로 강제 가능)
- 작업 루프를 더 일관되게 만든다
