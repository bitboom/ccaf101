...
- 비용
- 지연 시간
- 실패 항목 처리 ([[concepts/execution-safety/validation-repair-and-retry-loops|validation/repair/retry]])
- 전체 일관성 유지
...
예를 들어 100건을 처리할 때:
- 97건은 유효
- 3건은 [[concepts/output-design/schema-design-for-reliability|schema]] 실패
...
- [[concepts/execution-safety/validation-repair-and-retry-loops|validation과 repair]]가 복잡해짐
- 출력 패턴이 흔들릴 가능성이 높아짐
...
그래서 batch에서는:
- [[concepts/output-design/schema-design-for-reliability|schema]] validation
