...
하나의 큰 문제를 단일 agent([[concepts/agent-control/agent-loop|Agent Loop]])에게 한 번에 던지면 다음 문제가 생기기 쉽다.
...
단점:
- 구조가 흔들리기 쉽다
- [[concepts/agent-control/coordinator-subagent|Coordinator]] 품질에 크게 의존한다
...
- [[concepts/agent-control/hooks-and-enforcement|Hooks & Enforcement]]
- [[concepts/state-memory/context-lifecycle-management|Context Lifecycle Management]] — 분해된 작업 간 문맥 전달 설계
- [[concepts/agent-control/plan-mode-and-execution-control|Plan Mode & Execution Control]] — 분해 계획과 실행 제어
