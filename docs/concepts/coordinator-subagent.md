...
즉 structured error propagation도 멀티 에이전트 품질의 일부다.
...
### 오해 1. Subagent가 많을수록 무조건 좋다
아니다.  
너무 잘게 쪼개면 오히려 조정 비용이 늘고 중요한 연결을 놓칠 수 있다.

### 오해 2. Subagent는 coordinator의 문맥을 자동으로 안다
아니다.  
필요한 정보는 명시적으로 전달해야 한다.

### 오해 3. Coordinator는 단순히 결과를 모으기만 하면 된다
아니다.  
평가, 비교, 보완, 재위임까지 책임진다.

### 오해 4. 멀티 에이전트는 무조건 더 똑똑하다
아니다.  
잘 분해하고 잘 종합할 때만 더 좋아진다.
